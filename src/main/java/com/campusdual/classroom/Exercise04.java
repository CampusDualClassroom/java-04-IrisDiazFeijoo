...
public class Exercise04 {
    public static void main(String[] args) {
        ...
        System.out.println("Obtén el factorial del número 7 → (7!): " + result );
        int resultRecursive = recursiveFactorial(7);
        System.out.println("Obtén el factorial del número 7 → (7!): " + resultRecursive );
